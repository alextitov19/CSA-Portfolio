...
----------- | --------------------- | ---------------------------------------------
Neil Sahai | 5/5 | I worked on connecting my ATM to the [Main menu](https://github.com/alextitov19/CSAPortfolio/blob/e144b5ac0077c6de00be99166d22e07244117647/src/Menu/MenuUI.java#L61) and I also added to the ATM.java file by creating the [main panel](https://github.com/alextitov19/CSA-Portfolio/blob/e144b5ac0077c6de00be99166d22e07244117647/src/ATM/ATM.java#L84) from where the after the login function you deposit and withdraw money. I also added the logic to the [deposit and withdraw functions](https://github.com/Altoid0/CalculatorUI/blob/master/src/view/CalculatorUI.java) and made sure that the operations within the ATM are working with their intentded purpose. To use the ATM, the user logs in using the username CSA and the password test. Next week, I will be working with my group on integrating projects together with persistent memory so that the money connects all of our code.
